...
bool CalcPathWithRange(Level &level, Path &path, Vector2i start, Vector2i end, int range, Character *exceptCharacter);
bool CalcPathWithRangePartial(Level &level, Path &path, Vector2i start, Vector2i end, int range, Character *exceptCharacter);
