...
namespace deprecated {
    ...
    static void
    LoadAnimType(SpriteData &spriteData, std::map<SpriteAnimationType, int> &animations, const std::string &animType,
                 bool hasAttacks) {
    ...
    void InitCharacterSprite(SpriteData &spriteData, CharacterSprite &sprite, const std::string &spriteTemplate,
                             bool hasAttacks) {
    ...
    void
    SetCharacterSpriteWeaponAnimation(SpriteData &spriteData, CharacterSprite &sprite, const std::string &weaponType) {
    ...
    void StartPausedCharacterSpriteAnim(SpriteData &spriteData, CharacterSprite &sprite, SpriteAnimationType type,
                                        bool loop) {
        PlaySpriteAnimation(spriteData, sprite.bodyPlayer, GetCharacterAnimationBody(sprite, type), loop);
    ...
    void
    DrawCharacterSpriteColors(SpriteData &spriteData, CharacterSprite &sprite, float x, float y, Color c1, Color c2,
                              Color c3, Color c4) {
    ...
    void PlayCharacterSpriteAnimRestart(SpriteData &spriteData, CharacterSprite &sprite, SpriteAnimationType type,
                                        bool loop) {
        PlaySpriteAnimationRestart(spriteData, sprite.bodyPlayer, GetCharacterAnimationBody(sprite, type), loop);
        if (sprite.displayWeapon)
            PlaySpriteAnimationRestart(spriteData, sprite.weaponPlayer, GetCharacterAnimationWeapon(sprite, type),
                                       loop);
    }
